<div class="fixed z-40  overflow-auto top-0 bottom-0 left-0">
<aside class="lg:w-64 z-40 flex" aria-label="Sidebar">
        <div class="!min-h-screen py-4 px-5 pt-20 bg-base-200  ">
            <ul class="space-y-2">
